...
public class Places {
    ...
    public static Place COAL_MINE = new Place("Coal Mine", "Dustied paint yolo", "You acquired a Coal Mine!", Arrays.asList(RAT, WILD_BAT, RAT), null, WORLD_RADIUS / 2, WORLD_RADIUS - 1, 1, WORLD_RADIUS / 9);
    ...
    public static Place OREMINE = new Place("Ore Mine", "Some things shine in the distance", "This requries more research", null, null, 1, WORLD_RADIUS / 4, WORLD_RADIUS / 4, WORLD_RADIUS / 2 - 1);
